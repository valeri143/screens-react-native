    ...
    >
       <Tabs.Screen name="PostsScreen" options={{title:"Публікації",headerStyle:{height:100}, headerTitleStyle: {
         marginTop:50
          ...
          <Tabs.Screen name="CreatePostsScreen" options={{
            ...
            headerLeft: () => (
              <Pressable onPress={() => navigation.navigate("PostsScreen")}>
                 <Ionicons name="arrow-back" size={24} color="gray" style={{marginLeft: 20, marginTop:50}} />
              </Pressable>
             
            ),
              tabBarLabelStyle: { display:"none"}, tabBarIconStyle:{backgroundColor:"#FF6C00", width:70, height:40,marginTop:8, borderRadius:20}
...
//             iconName = 'grid-outline';
//           } else if (route.name === 'CreatePostsScreen') {
//             iconName = isActive ? 'person-outline' : 'add-outline';
